...
| WRA10 | I can evaluate the **social implications of surveillance** in data practices, recognizing how data collection and modeling affects privacy, agency, and power dynamics.                  |
...
| VIS03 | I can customize common plot elements such as axes, tick marks, labels, and titles.                                                                                                       |
| VIS04 | I can create and modify visualizations using Plotly Graph Objects by understanding and applying its object-oriented structure (e.g., go.Figure, go.Scatter, update_layout, add_trace).   |
| VIS05 | I can customize common plot elements such as axes, tick marks, labels, and titles.                                                                                                       |
...
| MOD06 | I can apply preprocessing techniques such as scaling, ordering one-hot encoding to prepare data for modeling.                                                                            |
| MOD07 | I can explain how tree depth and complexity relate to overfitting in decision trees.                                                                                                     |
...
| MOD12 | I can address unbalanced data using methods such as resampling or class weighting.                                                                                                       |
| MOD13 | I can apply and evaluate logistic regression models using probability thresholds, ROC curves, and AUC.                                                                                   |
...
| MOD18 | I can recognize cases where predictions may influence outcomes in ways that are ethically or socially problematic, such as through unwarranted inferences or self-fulfilling prophecies. |
...
| MOD20 | I can use interpretability methods like feature importance, SHAP, or partial dependence plots to understand some model results.                                                          |
