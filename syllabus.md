...
```{admonition} Catalog Description
:class: note
...
-   Professor Fernando Pasquini Santos - fs33
    -   office hours: at NH291, Tuesdays 4-5 pm, Wednesdays 11-12 am; send e-mail if you need to meet at another time.
-   Grader: Ivan Widjanarko

## Materials

Course materials are (mostly) taken from:
