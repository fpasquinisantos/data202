...
| Week        | Topic                            | Notes                                                  |
|-------------|----------------------------------|--------------------------------------------------------|
| 1 (Sep 2)   | Intro - purposes and tools       | [**No Monday (Labor Day)**]{.class style="color:red"}  |
| 2 (Sep 9)   | Data visualization concepts      |                                                        |
| 3 (Sep 16)  | Data visualization practice      |                                                        |
| 4 (Sep 23   | Data wrangling concepts          |                                                        |
| 5 (Sep 30   | Data wrangling practice          |                                                        |
| 6 (Oct 7)   | Modeling basics                  |                                                        |
| 7 (Oct 14)  | Linear models                    |                                                        |
| 8 (Oct 21)  | *Fall Break*                     | *Class on Friday will complete week 7*                 |
| 9 (Oct 28)  | Tree-based models                |                                                        |
| 10 (Nov 4)  | Ensemble methods                 |                                                        |
| 11 (Nov 11) | Clustering                       |                                                        |
| 12 (Nov 18) | Time-series and SQL              |                                                        |
| 13 (Nov 25) | Interpretable models             | [**No Wed-Fri (Thanksgiving)**]{.class style="color:red"} |
| 14 (Dec 2)  | Fairness methods                 |                                                        |
| 15 (Dec 9)  | Missing data, validation methods | [**No Friday (Study Day)**]{.class style="color:red"}    |
...
-   Teaching assistant: Grace Van Farowe, gev22 %at& calvin.edu
